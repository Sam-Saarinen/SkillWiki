...
class AssignmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Assignment" do
    ...
    fill_in "Quiz score", with: @assignment.quiz_score
    fill_in "References", with: @assignment.references
    fill_in "Resources completed", with: @assignment.resources_completed
