...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post classrooms_url, params: { classroom: { name: @classroom.name, students: @classroom.students, user_id: @classroom.user_id } }
  #   end
  ...
  #   patch classroom_url(@classroom), params: { classroom: { name: @classroom.name, students: @classroom.students, user_id: @classroom.user_id } }
